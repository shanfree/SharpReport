 ...
 * 修改记录: 	修改时间		人员		修改备注
 *				----------		------		-------------------------------------------------
 *                              hxj        追加方法 public static CustomDataSet GetCutomList(string connectionString, string sql, SqlParameter[] paramList, string orderString, int pageSize, IList<T> list)
 ********************************************************************************************/
using System;
