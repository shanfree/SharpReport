...
namespace SIRC.Framework.SharpMemberShip.BLL
{
    ...
    {
        private readonly IDepartment dal = new DAL.Department();
        ...
        /// </summary>
        /// <returns>列表</returns>
        public IList<DepartmentInfo> GetList()
        {
            return dal.GetList();
        }
        ...
        public string Add(DepartmentInfo cInfo)
        {
        ...
        /// </summary>
        /// <param name="cInfo">实体</param>
        public void Update(DepartmentInfo cInfo)
        {
        ...
        {
            DepartmentInfo cInfo = new DepartmentInfo();
            cInfo.ID = ID;
