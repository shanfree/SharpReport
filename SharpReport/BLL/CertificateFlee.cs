...
namespace Sirc.SharpReport.BLL
{
    ...
    /// 备件
    /// </summary>
    public partial class CertificateFlee
    {
        private readonly ICertificateFlee dal = DataAccess.CreateCertificateFlee();
        ...
        /// </summary>
        /// <returns>列表</returns>
        public IList<CertificateFleeInfo> GetList()
        {
            return dal.GetList();
        }
        ...
        /// <returns>实体</returns>
        public CertificateFleeInfo GetByID(string ID)
        {
