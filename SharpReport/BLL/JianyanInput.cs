...
namespace Sirc.SharpReport.BLL
{
    ...
    /// 备件
    /// </summary>
    public partial class JianyanInput
    {
        private readonly IJianyanInput dal = DataAccess.CreateJianyanInput();
        ...
        /// </summary>
        /// <returns>列表</returns>
        public IList<JianyanInputInfo> GetList()
        {
            return dal.GetList();
        }
        ...
        /// <returns>实体</returns>
        public JianyanInputInfo GetByID(string ID)
        {
