...
namespace Sirc.SharpReport.BLL
{
    ...
    /// 
    /// </summary>
    public partial class Currency : DBPersistenceBase<CurrencyInfo>, ICurrency
    {
        private readonly ICurrency dal = DataAccess.CreateCurrency();
        ...
        /// </summary>
        /// <returns>列表</returns>
        public IList<CurrencyInfo> GetList()
        {
            return dal.GetList();
        }
        ...
        public string Add(CurrencyInfo cInfo)
        {
        ...
        /// </summary>
        /// <param name="cInfo">实体</param>
        public void Update(CurrencyInfo cInfo)
        {
