...
namespace Sirc.SharpReport.BLL
{
    ...
    /// 备件
    /// </summary>
    public partial class InsuranceOfFreightTransport
    {
        private readonly IInsuranceOfFreightTransport dal = DataAccess.CreateInsuranceOfFreightTransport();
        ...
        /// </summary>
        /// <returns>列表</returns>
        public IList<InsuranceOfFreightTransportInfo> GetList()
        {
            return dal.GetList();
        }
        ...
        /// <returns>实体</returns>
        public InsuranceOfFreightTransportInfo GetByID(string ID)
        {
        ...
        public string Add(InsuranceOfFreightTransportInfo cInfo)
        {
        ...
        /// </summary>
        /// <param name="cInfo">实体</param>
        public void Update(InsuranceOfFreightTransportInfo cInfo)
        {
        ...
        {
            InsuranceOfFreightTransportInfo cInfo = new InsuranceOfFreightTransportInfo(ID);
            dal.Delete(cInfo);
        }
        #endregion
    }
