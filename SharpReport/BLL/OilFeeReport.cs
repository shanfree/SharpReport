...
{
    public partial class OilFeeReport
    {
        private readonly IOilFeeReport dal = DataAccess.CreateOilFeeReport();
        ...
        public OilFeeReportInfo GetByVoyageID(string voyageID)
        {
            ...
            {
                throw new ArgumentNullException("参数voyageID不能为空。");
            }
        ...
        /// </summary>
        /// <returns>列表</returns>
        public IList<OilFeeReportInfo> GetList()
        {
            return dal.GetList();
        }
        ...
        /// <returns>实体</returns>
        public OilFeeReportInfo GetByID(string ID)
        {
