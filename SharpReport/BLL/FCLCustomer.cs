...
namespace Sirc.SharpReport.BLL
{
    ...
    /// 数据访问类:FCLCustomer
    /// </summary>
    public class FCLCustomer
    {
        private readonly IFCLCustomer dal = DataAccess.CreateFCLCustomer();
        ...
        /// </summary>
        /// <returns>列表</returns>
        public IList<FCLCustomerInfo> GetList()
        {
            return dal.GetList();
        }
        ...
        /// <returns>实体</returns>
        public FCLCustomerInfo GetByID(string ID)
        {
