...
namespace Sirc.SharpReport.BLL
{
    ...
    {
        private readonly IReportType dal = DataAccess.CreateReportType();
        ...
        /// </summary>
        /// <returns>列表</returns>
        public IList<ReportTypeInfo> GetList()
        {
            return dal.GetList();
        }
        ...
        public string Add(ReportTypeInfo cInfo)
        {
        ...
        /// </summary>
        /// <param name="cInfo">实体</param>
        public void Update(ReportTypeInfo cInfo)
        {
        ...
        {
            ReportTypeInfo cInfo = new ReportTypeInfo();
            cInfo.ID = ID;
