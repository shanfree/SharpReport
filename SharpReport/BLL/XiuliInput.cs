...
namespace Sirc.SharpReport.BLL
{
    ...
    /// 备件
    /// </summary>
    public partial class XiuliInput
    {
        private readonly IXiuliInput dal = DataAccess.CreateXiuliInput();
        ...
        /// </summary>
        /// <returns>列表</returns>
        public IList<XiuliInputInfo> GetList()
        {
            return dal.GetList();
        }
        ...
        /// <returns>实体</returns>
        public XiuliInputInfo GetByID(string ID)
        {
