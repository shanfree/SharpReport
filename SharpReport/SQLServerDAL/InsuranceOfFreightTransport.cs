...
{
    /// <summary>
    /// 数据访问类:InsuranceOfFreightTransport
    /// </summary>
    public partial class InsuranceOfFreightTransport : DBPersistenceBase<InsuranceOfFreightTransportInfo>, IInsuranceOfFreightTransport
    {
        public InsuranceOfFreightTransport()
        { }

        #region sql
        private const string SQL_SELECT = @"SELECT * FROM InsuranceOfFreightTransport WHERE ID = @ID";
        #endregion
        ...
        /// <returns></returns>
        protected override InsuranceOfFreightTransportInfo WriteLazyLoadProperty(SqlDataReader reader, InsuranceOfFreightTransportInfo t)
        {
            string id = t.ID;
        ...
        public DataSet GetList(string year, string month, string shipID)
        {
            ...
            string sql = @"
                        select dbo.V_InsuranceOfFreightTransport.* from 
                        dbo.V_InsuranceOfFreightTransport
