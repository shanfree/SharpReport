...
namespace Sirc.SharpReport.SQLServerDAL
{
    ...
    /// 数据访问类:VoyageOther
    /// </summary>
    public partial class VoyageOther : DBPersistenceBase<VoyageOtherInfo>, IVoyageOther
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        #region sql
        private const string SQL_SELECT = @"SELECT * FROM V_VoyageOther WHERE ID = @ID";
        private const string SQL_SELECT_VOYAGEID = @"SELECT * FROM V_VoyageOther WHERE VoyageID = @VoyageID";
        #endregion
        ...
        public VoyageOtherInfo GetByVoyageID(string voyageID)
        {
            ...
            IList<VoyageOtherInfo> list = GetListFromReader(dr);
        ...
        /// </summary>
        /// <returns>列表</returns>
        public IList<VoyageOtherInfo> GetUnReporList()
        {
            string sql = @"
                        select * from V_VoyageOther
                        WHERE VoyageOtherID IS NULL ";
