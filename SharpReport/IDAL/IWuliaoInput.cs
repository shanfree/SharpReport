...
namespace Sirc.SharpReport.IDAL
{
    ...
    /// 接口层WuliaoInput
    /// </summary>
    public interface IWuliaoInput : IDBPersistenceBase<WuliaoInputInfo>
    {
        /// <summary>
        /// 获取列表
        /// </summary>
        ...
        /// <returns>列表</returns>
        DataSet GetList(string year, string month, string reportType, int pageSize, int pageIndex);
        /// <summary>
        /// 按发票的编号统计报表信息
        /// </summary>
        /// <param name="invoiceNo">发票的编号</param>
        DataSet GetList(string invoiceNo);
        /// <summary>
        /// 按年份，船舶统计报表信息
        /// </summary>
