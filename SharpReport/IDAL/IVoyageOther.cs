...
namespace Sirc.SharpReport.IDAL
{
    ...
    /// 接口层VoyageOther
    /// </summary>
    public interface IVoyageOther : IDBPersistenceBase<VoyageOtherInfo>
    {
        /// <summary>
        /// 根据航次ID获取实体
        /// </summary>
        ...
        /// <returns>实体</returns>
        VoyageOtherInfo GetByVoyageID(string voyageID);
        /// <summary>
        /// 获取列表
        /// </summary>
        ...
        /// <returns>列表</returns>
        IList<VoyageOtherInfo> GetList(string shipID);
        /// <summary>
        /// 获取还未填写 船舶油料航次消耗表 的航次
        /// </summary>
        /// <returns>列表</returns>
        IList<VoyageOtherInfo> GetUnReporList();
