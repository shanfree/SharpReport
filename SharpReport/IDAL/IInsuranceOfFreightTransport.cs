...
{
	/// <summary>
	/// 接口层InsuranceOfFreightTransport
	/// </summary>
    public interface IInsuranceOfFreightTransport : IDBPersistenceBase<InsuranceOfFreightTransportInfo>
	{
        /// <summary>
        /// 获取列表
        /// </summary>
        ...
        /// <returns>列表</returns>
        DataSet GetList(string year, string month, string shipID);
