...
namespace Sirc.SharpReport.IDAL
{
    ...
    /// 接口层VoyageFCL
    /// </summary>
    public interface IVoyageFCL : IDBPersistenceBase<VoyageFCLInfo>
    {
        /// <summary>
        /// 根据航次ID获取实体
        /// </summary>
        ...
        /// <returns>实体</returns>
        VoyageFCLInfo GetByVoyageID(string voyageID);
        /// <summary>
        /// 获取列表
        /// </summary>
        ...
        /// <returns>列表</returns>
        IList<VoyageFCLInfo> GetList(string shipID);
        /// <summary>
        /// 获取还未填写 船舶油料航次消耗表 的航次
        /// </summary>
        /// <returns>列表</returns>
        IList<VoyageFCLInfo> GetUnReporList();
