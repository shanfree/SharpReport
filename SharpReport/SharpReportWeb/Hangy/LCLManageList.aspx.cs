...
{
    public partial class LCLManageList : WebBasePage
    {
        #region 权限验证
        /// <summary>
        /// 该页面登录后访问
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    TitleInitial("散货船舶报表汇总", "散货船舶运费计费报表汇总。载货情况根据船只的“装箱类型”填写：“集装箱”船填写箱量相关信息，“散货”船填写散货载货量信息。");
        ...
        protected void gvLCL_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                BindLCL(pGridV.CurrentPageIndex);
                ShowMsg("操作成功！");
            }
            catch (ArgumentException ae)
            {
