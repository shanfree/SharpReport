<%@ Page  Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true" CodeBehind="CommonFeeStatistic.aspx.cs" Inherits="SharpReportWeb.HR.CommonFeeStatistic"  Title="人资部费用年度汇总" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphTop" runat="server">
    ...
    <div class="window">
        ...
        <div id="SlideBox">
            <uc1:CommonFeeStatistic ID="cfs_List" runat="server" DepartmentID="5"/>
        </div>
    </div>
</asp:Content>
