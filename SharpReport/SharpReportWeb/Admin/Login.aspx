...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #loginPanel
        {
            background: url(../Images/loginPanel.png) center no-repeat;
        }
    </style>
</head>
<body>
    ...
    <div id="loginPanel">
        <asp:TextBox ID="userName" runat="server" Text="admin"></asp:TextBox>
        <asp:TextBox ID="password" runat="server" TextMode="SingleLine" Text="1"></asp:TextBox>
        ...
        <div id="loginTips">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*用户名称不能为空。"
                Display="Dynamic" ControlToValidate="userName"></asp:RequiredFieldValidator><br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*用户密码不能为空。"
                Display="Dynamic" ControlToValidate="password"></asp:RequiredFieldValidator>
            如无法登入，请联系系统管理员。
        </div>
    </div>
    </form>
