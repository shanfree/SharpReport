<%@ Page Language="C#" MasterPageFile="~/MasterPage/Admin.master" AutoEventWireup="true"
    CodeBehind="Log.aspx.cs" Inherits="SharpReportWeb.Admin.Log" Title="日志管理" %>
            ...
            <tr>
                ...
                <td style="border: none" valign="top">
                    <table width="95%">
                            ...
                            <td colspan="2">
                                <div style="width: 100%; height: 400px; overflow: auto">
                                    <asp:GridView ID="gvLogInfoList" runat="server" AutoGenerateColumns="False" Width="100%"
                                        OnRowDataBound="gvLogInfoList_RowDataBound" PageSize="10" CssClass="t">
                                        <Columns>
                        ...
                        <tr>
                            <td>
                                <cc1:ExcelGenButton ID="ExcelGenButton1" runat="server" CssClass="btn" GridViewID="gvLogInfoList"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tbDetail" runat="server" Rows="20" TextMode="MultiLine" Width="100%" CssClass="inputText"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
