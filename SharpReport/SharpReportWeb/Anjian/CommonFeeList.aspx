<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true"
    CodeBehind="CommonFeeList.aspx.cs" Inherits="SharpReportWeb.Anjian.CommonFeeList" EnableEventValidation="false"
    Title="安监部费用情况汇总" %>
    ...
    <div class="window">
        ...
        <div class="SlideBox">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form">
                ...
                <tr>
                    <th colspan="4" class="mass BGx">
                        安监部费用情况汇总：（新增月份请选择费用发生的月份）
                    </th>
                </tr>
                <tr>
                    <th colspan="4" align="left">
                        <uc1:WUC_CommonFee ID="WUC_CommonFee1" runat="server" DepartmentID="4" />
