<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true"
    CodeBehind="BeijianList.aspx.cs" Inherits="SharpReportWeb.ChuanJ.BeijianList" Title="备件报表" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphTop" runat="server">
    ...
    <div class="window">
        <div class="title BGx">
            <span>备件报表查询</span><asp:Button ID="btnAdd" runat="server" Text="新增" CssClass="btn"
                OnClick="btnAdd_Click" /></div>
        <div id="SlideBox">
            <div>
                <asp:GridView ID="gvBeijianList" runat="server" AutoGenerateColumns="False" Width="100%"
                    CssClass="t" PageSize="12" OnRowDataBound="gvBeijianList_RowDataBound" OnRowCommand="gvBeijianList_RowCommand">
                    <Columns>
