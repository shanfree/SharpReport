<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true"
    CodeBehind="XiuliList.aspx.cs" Inherits="SharpReportWeb.ChuanJ.XiuliList" Title="修理报表" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphTop" runat="server">
    ...
    <div class="window">
        <div class="title BGx">
            <span>修理报表查询</span><asp:Button ID="Button1" runat="server" Text="新增" CssClass="btn"
                OnClick="btnAdd_Click" /></div>
        <div id="SlideBox">
            <asp:GridView ID="gvXiuliList" runat="server" AutoGenerateColumns="False" Width="100%"
                CssClass="t" PageSize="12" OnRowDataBound="gvXiuliList_RowDataBound" OnRowCommand="gvXiuliList_RowCommand">
                <Columns>
