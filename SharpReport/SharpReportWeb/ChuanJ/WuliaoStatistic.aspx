<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true"
    CodeBehind="WuliaoStatistic.aspx.cs" Inherits="SharpReportWeb.ChuanJ.WuliaoStatistic"
    Title="物料报表统计" %>
            ...
            <div>
                <asp:GridView ID="gvWuliaoList" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="物料金额" DataField="总数" ItemStyle-Width="10%"></asp:BoundField>
                        <asp:BoundField HeaderText="生产用品" DataField="生产用品" ItemStyle-Width="10%"></asp:BoundField>
                        <asp:BoundField HeaderText="生活用品" DataField="生活用品" ItemStyle-Width="10%"></asp:BoundField>
                        <asp:BoundField HeaderText="办公用品" DataField="办公用品" ItemStyle-Width="10%"></asp:BoundField>
                        <asp:BoundField HeaderText="油漆" DataField="油漆" ItemStyle-Width="10%"></asp:BoundField>
                        <asp:BoundField HeaderText="缆绳" DataField="缆绳" ItemStyle-Width="10%"></asp:BoundField>
                        <asp:BoundField HeaderText="锁具" DataField="锁具" ItemStyle-Width="10%"></asp:BoundField>
                        <asp:BoundField HeaderText="药品" DataField="药品" ItemStyle-Width="10%"></asp:BoundField>
                        <asp:BoundField HeaderText="其他" DataField="其他" ItemStyle-Width="10%"></asp:BoundField>
                    </Columns>
