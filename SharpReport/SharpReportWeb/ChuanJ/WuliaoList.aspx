<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true"
    CodeBehind="WuliaoList.aspx.cs" Inherits="SharpReportWeb.ChuanJ.WuliaoList" Title="物料报表" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphTop" runat="server">
    ...
    <div class="window">
        <div class="title BGx">
            <span>物料报表查询</span><asp:Button ID="btnAdd" runat="server" Text="新增" CssClass="btn"
        ...
        <div id="SlideBox">
            ...
            <cc1:ExcelGenButton ID="ExcelGenButton1" runat="server" GridViewID="gvWuliaoList"
                OnClick="ExcelGenButton1_Click" Text="生成Excel" CssClass="btn" Style="text-align: right">
            </cc1:ExcelGenButton>
