<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true"
    CodeBehind="BeijianInputPage.aspx.cs" Inherits="SharpReportWeb.ChuanJ.BeijianInputPage"
    Title="备件报表登记" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphTop" runat="server">
        ...
        <div id="SlideBox">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form">
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox CssClass="inputText" ID="tb电器" runat="server" Text="0"></asp:TextBox>
                    </td>
                    <td align="right" class="tint">
                        分油机：
                    </td>
                    <td align="left">
                        <asp:TextBox CssClass="inputText" ID="tb分油机" runat="server" Text="0"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="tint">
                    ...
                    <td align="left">
                        <asp:TextBox CssClass="inputText" ID="tb辅机" runat="server" Text="0"></asp:TextBox>
                    </td>
                    <td align="right" class="tint">
                        副机：
                    </td>
                    <td align="left">
                        <asp:TextBox CssClass="inputText" ID="tb副机" runat="server" Text="0"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="tint">
                    ...
                    <td align="left">
                        <asp:TextBox CssClass="inputText" ID="tb舾装" runat="server" Text="0"></asp:TextBox>
                    </td>
                    <td align="right" class="tint">
                        主机：
                    </td>
                    <td align="left">
                        <asp:TextBox CssClass="inputText" ID="tb主机" runat="server" Text="0"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="tint">
    ...
    <uc1:InvoiceList ID="InvoiceList1" ReportType="4" runat="server" />
</asp:Content>
